          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-6 p-4 rounded-2xl bg-base-100 border border-base-300 hover:border-primary/50 transition-all group">
                <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-black transition-colors">
                  <Mail size={24} />
                </div>
                <div>
              ...
              {isSuccess ? (
                ...
                <form onSubmit={onSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-primary text-black font-bold text-lg py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-secondary transition-all disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-primary/20"
                  >
                    {isSubmitting ? (

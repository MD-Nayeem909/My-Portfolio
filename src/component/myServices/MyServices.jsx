...
const ServiceItem = ({
  ...
  return (
    <div
      ...
      ${
        isActive
          ? "bg-linear-to-br from-base-300 to-base-100 p-8"
          : "bg-base-100 p-6 hover:bg-base-200"
      }`}
    >
        ...
        <div className="flex-1">
          ...
          <h3
            className={`font-bold transition-all ${
              isActive ? "text-4xl mb-4" : "text-2xl"
            }`}
          >
            {title}
          </h3>
            ...
            <div className="mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <ul className="grid grid-cols-2 gap-y-3 gap-x-4">
                {points.map((point, i) => (
                  <li
                    key={i}
                    className="flex items-center text-xs text-primary/80"
                  >
          ...
          {isActive && image && (
            <div className="mt-8 hidden md:block">
              <img
                src={image}
                alt={title}
                className="w-48 h-32 object-cover rounded-xl rotate-12 shadow-2xl border border-base-300"
              />
            </div>
          )}
        </div>
  ...
  const services = [
    {
      ...
      description:
        "Creating intuitive user interfaces and engaging experiences that convert users into customers.",
    ...
    },
    {
      ...
      description:
        "Developing fast, SEO-friendly, and responsive web applications using modern technologies.",
      points: ["React & Next.js", "Backend Integration", "Performance Setup"],
      image: "https://i.ibb.co.com/394QBzcM/Fast-Parcel.png",
    },
    {
      title: "Branding",
    ...
    },
    {
      ...
      description:
        "Adding life to your digital products with smooth transitions and meaningful animations.",
      points: ["Motion Graphics", "Lottie Animations", "Micro-interactions"],
      image:
        "https://design4users.com/wp-content/uploads/2018/07/californication_bus_animation_tubik.gif",
    },
  ];

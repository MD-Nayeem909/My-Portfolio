...
export default function OrbitingSkills() {
  ...
  return (
    <main className="w-full flex items-center justify-center overflow-hidden relative">
      {}
      ...
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-92 h-92 shadow-lg overflow-hidden z-10 opacity-95 rounded-full">
